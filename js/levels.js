...
brawl.state4.prototype = {
    ...
    create: function () {
        ...
        for (var i = 0; i < 4; i++) {
            if (i === 0) {
                ...
                var fontNumber = 30;
                var string = "You Automatically Stick on the Wall when you Jump on It. \n\n Move the Opposite Direction and Jump at the Same Time to Wall-Jump \n\n While in the Air Move Towards the Wall to Get Back on the Wall";
            }
            else {
                var x = 1250;
                var y = this.game.world.centerY;
    ...
    update: function () {
        ...
        //     this.player.customParams.mustJump = false;
        // }
        if ((this.cursors.left.isDown || this.player.customParams.leftMovement)&& this.player.body.touching.down) {
            this.player.body.velocity.x = -400;
            this.player.animations.play('left');
        }
        else if ((this.cursors.right.isDown || this.player.customParams.rightMovement) && this.player.body.touching.down) {
            this.player.body.velocity.x = 400;
            this.player.animations.play('right');
        }
        else {
