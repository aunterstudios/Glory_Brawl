...
brawl.game.prototype.spriteGen = function (sprite, positionInArray) {
    ...
    if (sprite.spriteType.name === groundOneWayKillObject.name || sprite.spriteType.name === groundOneWayPlayer.name) {
